        ...
        <div class="container-fluid paper-wrap bevel tlbr">
                    ...
                    <div class="col-sm-7">
                        ...
                        <div class="tittle-middle-header">
                            ...
                            <div class="alert">
                                ...
                                Welcome back,&nbsp;
                                <strong><?php echo $_SESSION['nama_lengkap'] ?></strong>&nbsp;&nbsp;Your last sig in at Yesterday, 16:54 PM
                            </div>
            ...
            <div class="content-wrap">
                ...
                <div id="footer">
                    ...
                    <div class="copyright"><?php echo date('Y'); ?> BPSDM Kementerian Dalam Negeri - </a> All Rights Reserved.</div>
