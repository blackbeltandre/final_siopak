                ...
                <ul style="margin-right:0;" class="nav navbar-nav navbar-right">
                    <li>
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            ...
                            ?>
                            <img alt="" class="admin-pic img-circle" src="<?php echo $photo ?>"><?php echo $this->session->userdata('nama_lengkap') ?> <b class="caret"></b>
                        </a>
<?php if(@$_SESSION['is_dupak'] == 1){ ?>

                        <ul style="margin-top:14px;" role="menu" class="dropdown-setting dropdown-menu">
                            <li>
                            <a href="<?php echo base_url() ?>biodata">
                                    <span class="entypo-user"></span>&#160;&#160;Biodata Diri</a>
                            </li>
                            <li>
                                <a href="<?php echo base_url() ?>repassword">
                                    <span class="entypo-vcard"></span>&#160;&#160;Ubah Password</a>
                            </li>
                            <!-- <li>
                                <a href="#">
